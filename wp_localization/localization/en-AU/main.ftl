api_root_link_header_not_found = WordPress REST API link not found in the site response
...
non_existent_site_error = A server with the specified computer name could not be found

http_authentication_required_error = The server at {$url} requires authentication. Please enter your username and password

http_authentication_rejected_error = The server at {$url} rejected your login credentials. Please enter a valid username and password.
...
oauth_response_url_error_unsuccessful_login = Login unsuccessful
