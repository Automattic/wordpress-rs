...
fn create_minimal_post() -> AnyPostWithEditContext {
    AnyPostWithEditContext {
        id: PostId(1),
        date: WpDateString("2024-01-01T00:00:00".to_string()),
        ...
        modified: WpDateString("2024-01-01T00:00:00".to_string()),
...
fn create_full_post() -> AnyPostWithEditContext {
    AnyPostWithEditContext {
        id: PostId(42),
        date: WpDateString("2024-01-15T10:30:00".to_string()),
        ...
        modified: WpDateString("2024-01-16T14:20:00".to_string()),
