...
CREATE TABLE entity_state (
    ...
    table_name TEXT NOT NULL,  -- 'posts_edit_context', 'categories_edit_context', etc.
    state INTEGER NOT NULL,     -- 0=Missing, 1=Fetching, 2=Cached, 3=Stale, 4=Failed
    error_message TEXT,
    updated_at TEXT NOT NULL,   -- ISO 8601 timestamp
    UNIQUE(entity_id, db_site_id, table_name)
);

-- Optimize lookups by entity
CREATE INDEX idx_entity_state_lookup ON entity_state(entity_id, db_site_id, table_name);
