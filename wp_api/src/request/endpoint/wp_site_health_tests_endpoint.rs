...
mod tests {
    use super::*;
    use crate::ParsedUrl;
    use crate::request::endpoint::tests::{fixture_api_base_url, validate_wp_site_health_endpoint};
    use rstest::*;
    use std::sync::Arc;
    ...
    #[fixture]
    fn endpoint(fixture_api_base_url: Arc<ParsedUrl>) -> WpSiteHealthTestsRequestEndpoint {
