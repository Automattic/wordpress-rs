...
wp_content_i64_id!(TemplatePartRevisionId);
...
pub enum WpApiParamTemplatePartRevisionsOrderBy {
    #[default]
    Date,
    Id,
    Include,
...
impl_as_query_value_from_to_string!(WpApiParamTemplatePartRevisionsOrderBy);

#[derive(Debug, Default, PartialEq, Eq, uniffi::Record, WpDeriveParamsField)]
#[supports_pagination(true)]
pub struct TemplatePartRevisionListParams {
    ...
    #[uniffi(default = [])]
    pub exclude: Vec<TemplatePartRevisionId>,
    /// Limit result set to specific IDs.
    #[uniffi(default = [])]
    pub include: Vec<TemplatePartRevisionId>,
    ...
    #[uniffi(default = None)]
    #[field_name("orderby")]
    pub orderby: Option<WpApiParamTemplatePartRevisionsOrderBy>,
}

// The template part revision response uses the parent template-parts controller's
...
pub struct SparseTemplatePartRevision {
...
pub struct TemplatePartRevisionDeleteResponse {
    pub deleted: bool,
    pub previous: TemplatePartRevisionWithEditContext,
}
