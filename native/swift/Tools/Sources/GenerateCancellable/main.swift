...
struct GenerateCancellable: ParsableCommand {
    ...
    mutating func run() throws {
        ...
        guard !extensionsCode.isEmpty else {
            return
        }
...
class ExtensionGenerator {
    ...
    func generateExtensionsCode() -> String {
        ...
        let content = sourceFile.description.trimmingCharacters(in: .whitespacesAndNewlines)
    ...
    private func createFunctionCallBody(
        ...
        let functionCallArgs =
            parameterArguments.isEmpty ? "context: context" : "\(parameterArguments), context: context"
