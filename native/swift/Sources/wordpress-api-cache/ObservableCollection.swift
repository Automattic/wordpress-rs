...
public protocol ObservableCollection<Element>: Sendable {
    ...
    /// An identifier for this specific collection (used to invalidate `NotificationCenter` handles)
    var handle: UInt64 { get }

    /// The method used to load data from the cache.
    /// Usually not implemented directly – if `Element` is correct this can be mapped automatically
