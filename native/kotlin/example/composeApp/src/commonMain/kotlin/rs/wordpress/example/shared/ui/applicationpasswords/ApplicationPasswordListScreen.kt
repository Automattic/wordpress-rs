...
@Composable
@Preview
fun ApplicationPasswordListScreen(
    apiClient: WpApiClient,
    viewModel: ApplicationPasswordListViewModel = remember { ApplicationPasswordListViewModel(apiClient) },
    onBackClicked: () -> Unit = {}
) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Application Passwords") },
                navigationIcon = {
