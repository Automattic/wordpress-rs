...
test_results_dir="./native/kotlin/api/kotlin/build/test-results/integrationTest"
...
echo "--- 🧪 Print test results directory contents"
ls -l ./native/kotlin/api/kotlin/build/test-results/integrationTest
