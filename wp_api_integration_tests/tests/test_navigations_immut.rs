...
#[case::after(generate!(NavigationListParams, (after, Some(unwrapped_wp_gmt_date_time("2020-08-14T17:00:00+00:00")))))]
#[case::modified_after(generate!(NavigationListParams, (modified_after, Some(unwrapped_wp_gmt_date_time("2024-01-14T17:00:00+00:00")))))]
#[case::before(generate!(NavigationListParams, (before, Some(unwrapped_wp_gmt_date_time("2023-08-14T17:00:00+00:00")))))]
#[case::modified_before(generate!(NavigationListParams, (modified_before, Some(unwrapped_wp_gmt_date_time("2024-01-14T17:00:00+00:00")))))]
