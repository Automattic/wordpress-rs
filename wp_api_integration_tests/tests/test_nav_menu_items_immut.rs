...
#[case::after(generate!(NavMenuItemListParams, (after, Some(unwrapped_wp_gmt_date_time("2020-08-14T17:00:00+02:00")))))]
#[case::modified_after(generate!(NavMenuItemListParams, (modified_after, Some(unwrapped_wp_gmt_date_time("2024-01-14T17:00:00+02:00")))))]
#[case::before(generate!(NavMenuItemListParams, (before, Some(unwrapped_wp_gmt_date_time("2023-08-14T17:00:00+00:00")))))]
#[case::modified_before(generate!(NavMenuItemListParams, (modified_before, Some(unwrapped_wp_gmt_date_time("2024-01-14T17:00:00+00:00")))))]
