...
#[case(generate!(UserListParams, (roles, vec![wp_api::users::UserRole::Author, wp_api::users::UserRole::Editor])))]
#[case(generate!(UserListParams, (slug, vec!["foo".to_string(), "bar".to_string()]), (roles, vec![wp_api::users::UserRole::Author, wp_api::users::UserRole::Editor])))]
#[case(generate!(UserListParams, (capabilities, vec![wp_api::users::UserCapability::EditThemes, wp_api::users::UserCapability::DeletePages])))]
